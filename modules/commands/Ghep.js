...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
        ...
        if(money < 50000) api.sendMessage("Bạn cần 50000 đô cho 1 lần ghép hãy tích cực làm việc hoặc xin admin bot!\n🤑Có làm mới có ăn🤑",event.threadID,event.messageID)
        else {
        var tl = ['100%', '100%', '100%', '100%', '100%', '100%', '100%', '100%', '100%', '100%', '100%', '100%', "100%", "100%"];
        ...
        var msg = {body: `Hoàn thanh ghép đôi bạn đã mất 50000 đô!\nNgười ghép đôi với bạn có giới tính: ${gender}\nTỉ lệ hợp đôi: ${tle}\n`+namee+" "+"💓"+" "+name, mentions: arraytag, attachment: imglove}
